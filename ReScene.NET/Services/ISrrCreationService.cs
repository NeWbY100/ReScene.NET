...
public interface ISrrCreationService
{
    ...
    /// </summary>
    /// <param name="outputPath">Destination path for the SRR file.</param>
    /// <param name="rarVolumePaths">Ordered list of RAR volume paths.</param>
    /// <param name="storedFiles">Optional files to embed, keyed by stored name to full path.</param>
    ...
    /// <param name="additionalFiles">Optional additional files to embed, keyed by stored name to full path.</param>
    /// <param name="options">Creation options.</param>
    /// <param name="ct">Cancellation token.</param>
    /// <returns>The creation result including success status and statistics.</returns>
